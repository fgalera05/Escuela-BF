...
function EditarAlumno({ thisAlumno, thisGeneros, onModificar, update }) {
  ...
  //   axios
  //     .get(
  //       process.env.REACT_APP_URL + "alumnos//alumno/ver/" + thisAlumno._id,
  //       {
  //         headers: {
        ...
        <DialogContent>
          ...
          >
            <div>
              ...
              {errors.apellido && (
                <ValidacionTexto
                  msg={"El apellido puede contener sólo letras."}
                />
              )}
              <TextField
                required
              ...
              {errors.nombre && (
                <ValidacionTexto
                  msg={"El nombre puede contener sólo letras."}
                />
              )}
            </div>
            <div>
              ...
              <TextField
                ...
                {...register("dni", {
                  ...
                  valueAsNumber: true,
                  validate: (value) =>
                    value > 0 && value < 99999999 && value > 9999999,
                })}
                aria-invalid={errors.dni ? "true" : "false"}
              />
              {errors.dni && (
                <ValidacionTexto
                  msg={"El DNI debe ser de 8 números: xxxxxxxx"}
                />
              )}
            </div>
            <div>
              ...
              {errors.telefono && (
                <ValidacionTexto
                  msg={"Ingrese el número de teléfono: 11XXXXXXXX"}
                />
              )}
              <BasicDatePicker
